...
export default function Hero({ onNavigate }: HeroProps) {
  ...
  return (
    <div className="relative min-h-screen flex items-center bg-gradient-to-br from-green-50 via-white to-green-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 transition-colors">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="text-left md:order-1 order-2">
            <p className="text-2xl md:text-3xl text-green-600 dark:text-green-400 mb-4 font-light">
              Tvarus, tylus ir galingas energijos šaltinis
            </p>

            <p className="text-xl md:text-2xl text-gray-900 dark:text-gray-100 mb-8 font-medium">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <button
                ...
                className="px-8 py-4 bg-white dark:bg-gray-800 text-green-600 dark:text-green-400 border-2 border-green-600 dark:border-green-500 rounded-lg font-semibold hover:bg-green-50 dark:hover:bg-gray-700 transition-all transform hover:scale-105 shadow-lg hover:shadow-xl"
              >
                Sužinoti daugiau
              </button>
            </div>
